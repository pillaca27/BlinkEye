...
export class PersonaComunSelectorComponent extends BaseComponent implements OnInit, UISelectorController {
    ...
    coreIniciarComponenteExtra(msj: MensajeController, centro: string){
        ...
        this.centrocostoServ.obtenerDtoPorId(centro).then(resp=>{
