...
export class SyReporteDetalleMantenimientoComponent extends FormularioComponent implements OnInit, UIMantenimientoController {
    constructor(
        private route: ActivatedRoute,
        private router: Router,
        private companyownerComunService: CompanyownerComunService,
        private servicio: SyReportearchivoComunService,
    ...
    ngOnInit() {
        ...
        this.syReporteArchivo = new DtoComunSyReportearchivo();
    ...
    nuevo(syReportePk: DtoComunSyReporte, tipo: string) {
        this.tituloMantenimientoAsignar(this.tituloMantenimientoTipo.ESTANDAR, this, '3', this.objetoBoton);
    ...
    verEjecucion(dto: DtoComunSyReportearchivo, tipo: string) {
    ...
    editar(dto: DtoComunSyReportearchivo, tipo: string) {
        this.tituloMantenimientoAsignar(this.tituloMantenimientoTipo.ESTANDAR, this, '3', this.objetoBoton);
    ...
    subirArchivoDet(dto: DtoComunSyReportearchivo, fs: any) {
        fs.click();
    ...
    bajarArchivoDet(dto: DtoComunSyReportearchivo) {
    ...
    guardarDet(dto: DtoComunSyReportearchivo) {
        // if (!this.validar()) {
        //     return;
        // }
