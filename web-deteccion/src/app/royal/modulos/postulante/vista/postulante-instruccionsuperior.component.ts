...
@Component({
    templateUrl: './postulante-instruccionsuperior.component.html',
    selector: 'postulante-instruccionsuperior'
})
export class PostulanteInstruccionSuperiorComponent extends FormularioComponent implements OnInit {
    ...
    refrescarVista(): Promise<number> {
        return this.hrPostulanteService.instruccionSuperiorListar(this.postulante).then(res => {
            this.lista = res;
            return 1;
        });
    }
    ...
    editar(dto: any) {
        ...
        this.dto.colegioprofesional = this.trim(this.dto.colegioprofesional);
        ...
        this.dto.auxFlagpracticas = this.dto.flagpracticas === 'S' ? true : false;
    ...
    eliminar(dto: any): void {
        this.confirmationService.confirm({
            ...
            accept: () => {
                this.bloquearPagina();
                this.hrPostulanteService.crud(dto, 'instruccionSuperiorEliminar').then(res => {
                    this.desbloquearPagina();
    ...
    guardar() {
        ...
        this.dto.flagpracticas = this.booleanAFlag(this.dto.auxFlagpracticas);
        var accionCRUD = this.accion == this.ACCIONES.NUEVO ? 'instruccionSuperiorRegistrar' : 'instruccionSuperiorActualizar';
    ...
    limpiarCentroEstudios() {
        this.dto.area = null;
        this.dto.auxAreaNombre = null;
        this.dto.profesion = null;
        this.dto.auxCarreraNombre = null;
    }
    ...
    coreMensaje(mensage: MensajeController): void {
        if (mensage.componente == 'CENTROESTUDIO') {
            ...
            if (carrera == null) {
                ...
                this.dto.auxAreaNombre = null;
                this.dto.profesion = null;
                this.dto.auxCarreraNombre = '(NINGUNA)';
            }
            else {
                if (carrera.profesion == null) {
                    ...
                    this.dto.area = carrera.profesionArea;
                    this.dto.auxAreaNombre = carrera.profesionAreaDescripcion;
                    this.dto.profesion = carrera.profesion;
                    this.dto.auxCarreraNombre = carrera.profesionDescripcion;
                }
            }
        }
    }
