...
@Component({
    selector: 'app-selector-ubicaciongeografica-postulante',
    templateUrl: './postulante-ubicaciongeografica-selector.component.html'
})
export class PostulanteUbicacionGeograficaSelectorComponent extends BaseComponent implements OnInit, UISelectorController {
    ...
    constructor(
        private departamentoService: HrPostulanteService,
    ...
    iniciarComponente(msj: MensajeController, pais: string) {
