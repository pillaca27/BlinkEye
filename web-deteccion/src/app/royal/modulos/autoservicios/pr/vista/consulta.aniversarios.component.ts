...
@Component({
  templateUrl: './consulta.aniversarios.component.html'
})
export class ConsultaAniversarioComponent extends FormularioComponent implements OnInit, UIListadoController {

  @ViewChild(Table, { static: false }) dt: Table;
  @ViewChild(PersonaComunSelectorComponent, { static: false }) personaComunSelectorComponent: PersonaComunSelectorComponent;

  filtro: FiltroConsultaAniversario = new FiltroConsultaAniversario();
  ...
  ngOnInit() {
    ...
    this.lstSigno.push({ label: 'Menor a', value: '<' });
    this.lstSigno.push({ label: 'Mayor a', value: '>' });
    this.lstSigno.push({ label: 'Igual a', value: '=' });
    this.lstSigno.push({ label: 'Menor igual a', value: '<=' });
    this.lstSigno.push({ label: 'Mayor igual a', value: '>=' });
  ...
  cargarListado(event: LazyLoadEvent) {
    ...
    this.prPlanillaempleadoServicio.consultaAniversario(this.filtro)
      .then(res => {
