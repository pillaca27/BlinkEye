...
@Component({
  templateUrl: './consulta.quintacategoria.component.html'
})
export class ConsultaQuintaCategoriaComponent extends FormularioComponent implements OnInit, UIListadoController {

  @ViewChild(Table, { static: false }) dt: Table;

  filtro: FiltroConsultaQuintaCategoria = new FiltroConsultaQuintaCategoria();
  ...
  ngOnInit() {
    ...
    this.prPlanillaempleadoServicio.listarPeriodosQuintaCategoria().then(res => {
      res.forEach(row => {
  ...
  imprimir() {
    ...
    this.bloquearPagina();
    this.prPlanillaempleadoServicio.imprimirQuintaCategoria(this.filtro)
      .then(respuesta => {
        this.desbloquearPagina();
