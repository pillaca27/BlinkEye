...
@Component({
    selector: 'app-selector-gradosalario',
    templateUrl: './gradosalario-selector.component.html'
})
export class GradoSalarioSelectorComponent extends BaseComponent implements OnInit, UISelectorController {
    ...
    listarDefecto() {
        ...
        this.hrRequerimientoServicio.listarGradoSalario(this.filtro)
            .then(pg => {
                this.lista = pg;
