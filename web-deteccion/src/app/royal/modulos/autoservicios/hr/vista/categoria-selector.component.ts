...
export class CategoriaSelectorComponent extends BaseComponent implements OnInit, UISelectorController {
    ...
    listarDefecto() {
        ...
        this.hrRequerimientoServicio.listarCategorias(this.filtro)
            .then(pg => {
                this.lista = pg;
