...
@Component({
    selector: 'app-selector-tipotrabajador',
    templateUrl: './tipotrabajador-selector.component.html'
})
export class TipotrabajadorSelectorComponent extends BaseComponent implements OnInit, UISelectorController {
    ...
    listarDefecto() {
        ...
        this.hrRequerimientoServicio.listarTipoTrabajador(this.filtro)
            .then(pg => {
                this.lista = pg;
