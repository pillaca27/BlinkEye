...
export class SyPreferencesListadoComponent extends FormularioComponent implements OnInit, UIListadoController {
    ...
    coreNuevo(): void {
        this.router.navigate([ConstanteSg.ruta_sypreferences_mantenimiento, this.ACCIONES.NUEVO], { skipLocationChange: true })
    }

    coreEditar(dto: DtoSyPreferences){
        this.router.navigate([ConstanteSg.ruta_sypreferences_mantenimiento, this.ACCIONES.EDITAR, JSON.stringify(dto)], { skipLocationChange: true });
    }

    coreVer(dto: DtoSyPreferences){
        this.router.navigate([ConstanteSg.ruta_sypreferences_mantenimiento, this.ACCIONES.VER, JSON.stringify(dto)], { skipLocationChange: true });
    }
