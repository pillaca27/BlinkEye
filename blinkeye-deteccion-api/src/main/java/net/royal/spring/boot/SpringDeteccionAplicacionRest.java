...
@RestController
@RequestMapping("/spring/publico/autoservicios")
@CrossOrigin(origins = "*")
public class SpringDeteccionAplicacionRest {
	...
	public ResponseEntity<String> estavivobd() {
		String now="";
		try {
			List lst = whItemmastDao.listarPorQuery(DtoTabla.class, "proveedormast.estavivobd");
			if (lst.size()==1) {
