...
public abstract class GenericoApiImpl<T> {
	...
	public static String proxySeguridad = "proxy.framework.seguridad";
	public static String proxyComun = "proxy.framework.comun";
	public static String proxyMantenimiento = "proxy.erp.mantenimiento";
	public static String proxyWorkflow = "proxy.framework.workflow";
	public static String proxyProveedor= "proxy.erp.proveedor";
	public static String proxyWh= "proxy.erp.wh";
	public static String proxyLogistica = "proxy.erp.logistica";
	...
	public void leerPropiedades(String api) throws Exception {
	...
	public void leerPropiedadesTodas() throws Exception {
		String rutaPropiedades = UWebServer.rutaFisicaWebServer() + File.separator + ConstanteBoot.CARPETA_PROPERTIES;
		logger.debug(rutaPropiedades);
		propiedades = UPropiedades.getInstance().abrir(rutaPropiedades, ConstanteBoot.PROPERTIES_GLOBAL);
		logger.debug(propiedades);
	...
	public T get(String metodo,T entity) throws URISyntaxException {
	...
	public T getSeguro(String metodo,Class c) throws Exception {
		URI uri = new URI(apiUrl + "/" + metodo);
		RestTemplate restTemplate = new RestTemplate();			
		HttpEntity<T> reqlocal = new HttpEntity<T>(this.getHeadersSeguro());		
		ResponseEntity<T> result = restTemplate.exchange(uri, HttpMethod.GET, reqlocal,c);
		T entity = result.getBody();			
		return entity;
	}
	
	public List<T> getToLista(String metodo) {
		try {			
			URI uri = new URI(apiUrl + "/" + metodo);
	...
	public List<DtoTabla> getToListaTabla(String metodo) {
		try {			
			URI uri = new URI(apiUrl + "/" + metodo);
	...
	public T putObtenerPorId(String metodo,T entity) {
	...
	public T put(String metodo,T entity) {
		try {
			Class claselocal = entity.getClass();						
			URI uri = new URI(apiUrl + "/" + metodo);
...
//			logger.debug("GenericoApiImpl.put : despues del llamado");
	...
	public T putSeguro(String metodo,T entity) {
		try {
			Class claselocal = entity.getClass();						
			URI uri = new URI(apiUrl + "/" + metodo);
			RestTemplate restTemplate = new RestTemplate();			
	...
	public Object putBeanToBean(String metodo,Object entity) {
		try {
			Class claselocal = entity.getClass();						
			URI uri = new URI(apiUrl + "/" + metodo);
			RestTemplate restTemplate = new RestTemplate();			
	...
	public Object putBeanToBean(String metodo,Object entity,Class classSalida) {
		try {
			URI uri = new URI(apiUrl + "/" + metodo);
			RestTemplate restTemplate = new RestTemplate();			
			HttpEntity<Object> reqlocal = new HttpEntity<Object>(entity,this.obtenerHeaders());			
	...
	public List<DtoTabla> putBeanToListaTabla(String metodo,T entity) {
		try {			
			URI uri = new URI(apiUrl + "/" + metodo);
			RestTemplate restTemplate = new RestTemplate();			
			HttpEntity<T> reqlocal = new HttpEntity<T>(entity,this.obtenerHeaders());			
	...
	public String putToString(String metodo,T entity) {
		try {
	...
	public BigDecimal putToBigDecimal(String metodo,T entity) {
		try {
	...
	public List<T> putToLista(String metodo,T entity) {
	...
	public DtoTabla putTablaToTabla(String metodo,DtoTabla dto) {
		try {
	...
	public List<DtoTabla> putTablaToListaTabla(String metodo,DtoTabla dto) {
		try {			
			URI uri = new URI(apiUrl + "/" + metodo);
	...
	public Object postBeanToBean(String metodo,Object objEntrada,Class classSalida) {
		try {
			URI uri = new URI(apiUrl + "/" + metodo);
			RestTemplate restTemplate = new RestTemplate();			
	...
	public Object postBeanToBeanSeguro(String metodo,Object objEntrada,Class classSalida) {
		try {
			URI uri = new URI(apiUrl + "/" + metodo);
			RestTemplate restTemplate = new RestTemplate();			
	...
	public HttpHeaders getHeadersSeguro() throws Exception {
	...
	public HttpHeaders obtenerHeaders() {
		return obtenerHeaders(null);
	}

	public HttpHeaders obtenerHeaders(SeguridadUsuarioLogin token) {
		HttpHeaders headers = new HttpHeaders();
	...
	public String leerruta(String api) throws Exception {
		String rutaPropiedades = UWebServer.rutaFisicaWebServer() + File.separator + ConstanteBoot.CARPETA_PROPERTIES;
		logger.debug(rutaPropiedades);
		propiedades = UPropiedades.getInstance().abrir(rutaPropiedades, ConstanteBoot.PROPERTIES_GLOBAL);
		logger.debug(propiedades);
	...
	public void registrarError(String proceso, String descripcionError) throws Exception {
	...
	public void registrarError(String proceso, String descripcionError, String classname) throws Exception {
		ErrorTransaccion bean = new ErrorTransaccion();
		bean.setProceso(proceso);
		bean.setDescripcionError(descripcionError);
	...
	public void registrarError(ErrorTransaccion bean) throws Exception {
		try {
			String rutaPropiedades = UWebServer.rutaFisicaWebServer() + File.separator + ConstanteBoot.CARPETA_PROPERTIES;
			Properties propiedades;
			propiedades = UPropiedades.getInstance().abrir(rutaPropiedades, ConstanteBoot.PROPERTIES_GLOBAL);
			String apiErrorRegistrar = UString.obtenerSinNulo(propiedades.getProperty("error.registrar"));
	...
	public ResponseEntity<Object> handleAllExcepcions(Exception ex, WebRequest request) {
		...
		try {
			...
			String msg = ex.getMessage();
			logger.debug(msg);
			if(UString.trimSinNulo(msg).startsWith("401")||UString.trimSinNulo(msg).startsWith("407")||UString.trimSinNulo(msg).startsWith("403")) {
