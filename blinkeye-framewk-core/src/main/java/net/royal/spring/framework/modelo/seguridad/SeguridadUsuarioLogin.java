...
//	public static final String TIPOUSUARIO_EXTERNO = "EXTR";
	...
	//DOCENTE Y ALUMNO
	public static final String TIPOUSUARIO_DOCENTE = "DOCENTE";
	public static final String TIPOUSUARIO_AUXILIAR = "AUXILIAR";
	public static final String TIPOUSUARIO_ALUMNO = "ALUMNO";
	public static final String TIPOUSUARIO_DIRECTOR = "DIRECTOR";
	public static final String TIPOUSUARIO_SUBDIRECTOR = "SUBDIRECTOR";
