...
public class GenericoServicioImpl extends GenericoServicioBase {
	...
	public WorkFlowSeguimiento workflowSeguimiento(WorkFlowSeguimiento bean, Integer nivelActual) throws Exception {		
		return workflowSeguimiento(bean, false, nivelActual);
	}
	public WorkFlowSeguimiento workflowSeguimiento(WorkFlowSeguimiento bean, boolean headersInseguros,Integer nivelActual) throws Exception {
		try {
			bean.setNivelActual(nivelActual);
...
//			json.setDescripcion(mapper.writeValueAsString(exp.getLstDatos()));
	...
	public EmailTransaccion correoEnviar(EmailTransaccion bean) throws Exception {
		return correoEnviar(bean, null);
	}

	public EmailTransaccion correoEnviar(EmailTransaccion bean, SeguridadUsuarioLogin token) throws Exception {
	...
	public HttpHeaders getHeadersInseguro() {
		...
		headers.add(ConstanteFiltro.USUARIO_SEGURO, ConstanteFiltro.USUARIO_SEGURO);
		return headers;
	}
