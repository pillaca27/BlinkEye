...
public class SeguridadMenuItem {
	...
	private List<SeguridadObjetoBoton> botones=new ArrayList<SeguridadObjetoBoton>();

	public List<SeguridadObjetoBoton> getBotones() {
		return botones;
	}

	public void setBotones(List<SeguridadObjetoBoton> botones) {
	...
	public SeguridadMenuItem() {
		// TODO Auto-generated constructor stub
	}
	public SeguridadMenuItem(String label, String icon, String routerLink) {
		super();
		this.label = label;
		this.icon = icon;
