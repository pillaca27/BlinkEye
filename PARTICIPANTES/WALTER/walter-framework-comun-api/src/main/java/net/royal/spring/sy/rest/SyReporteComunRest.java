...
import net.royal.spring.sy.servicio.impl.SyReporteServicioImpl;
...
public class SyReporteComunRest extends GenericoHibernateRest {
	 ...
	 * @throws Exception
	 */
	@ApiOperation(notes = "-Descripcion: Eliminar | DtoComunSyReporte | Parametros de salida: DtoComunSyReporte", value = "SY-REPORTE-CREGIST", tags = {
			"SISTEMA", "REPORTE" })
	@Transactional
	 ...
	 * @throws Exception
	 */
	@ApiOperation(notes = "-Descripcion: obtener por id | DtoComunSyReporte | Parametros de salida: DtoComunSyReporte", value = "SY-REPORTE-COBTDTO", tags = {
			"SISTEMA", "REPORTE" })
	 ...
	 * @throws Exception
	 */
	@ApiOperation(notes = "-Descripcion: obtener por id | DtoComunSyReporte | Parametros de salida: DtoComunSyReporte", value = "SY-REPORTE-CACTUA", tags = {
			"SISTEMA", "REPORTE" })
	@Transactional
	 ...
	 * @throws Exception
	 */
	@ApiOperation(notes = "-Descripcion: obtener por id | FiltroComunSyReporte | Parametros de salida: DominioPaginacion", value = "SY-REPORTE-CLISPAG", tags = {
			"SISTEMA", "REPORTE" })
	@Transactional(readOnly = true)
	...
	public ResponseEntity<DominioPaginacion> listarpaginadoReportes(@RequestBody FiltroComunSyReporte paginacion)
			throws Exception {

		return new ResponseEntity<DominioPaginacion>(
				servicio.listarpaginadoReportes(this.getUsuarioActual(), paginacion), HttpStatus.OK);
	}

	@Transactional
	@PostMapping(value = "/exportarReportes", produces = MediaType.APPLICATION_JSON_VALUE)
	public void exportarReportes(HttpServletResponse response, @RequestBody FiltroComunSyReporte filtro)
			throws Exception {
		...
		String[] arrColumnas = new String[] { "aplicacionDescripcion", "reportecodigo", "descripcionlocal", "tipo",
				"estadodescripcion" };
	...
	/*@Transactional(readOnly = true)
	@PostMapping(value = "/exportarJsonReportes", produces = MediaType.APPLICATION_JSON_VALUE)
	public DtoExportarReportes exportarJsonReportes(@RequestBody FiltroComunSyReporte filtro) throws Exception {
		return servicio.exportarJsonReportes(filtro);
	}
	
	@Transactional
	@PostMapping(value = "/importarJsonReportes", produces = MediaType.APPLICATION_JSON_VALUE)
	public DtoExportarReportes importarJsonReportes(@RequestBody DtoExportarReportes dto) throws Exception {
		return servicio.importarJsonReportes(dto);
	}*/
