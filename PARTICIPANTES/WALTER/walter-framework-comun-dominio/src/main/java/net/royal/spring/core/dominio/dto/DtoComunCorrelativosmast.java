...
public class DtoComunCorrelativosmast extends DominioTransaccion implements java.io.Serializable{
	...
	private Integer auxCerosIzquierda;
	private String anio;
	...
	public DtoComunCorrelativosmast(String companiacodigo,String tipocomprobante,String serie,Integer auxCerosIzquierda) {
		this.companiacodigo=companiacodigo;
		this.tipocomprobante=tipocomprobante;
		this.serie=serie;
	...
	public Integer getAuxCerosIzquierda() {
		return auxCerosIzquierda;
	}
	public void setAuxCerosIzquierda(Integer auxCerosIzquierda) {
		this.auxCerosIzquierda = auxCerosIzquierda;
	}
	...
	public BeanCorrelativosmast obtenerBean(BeanCorrelativosmast bean) {
		...
		bean.setCorrelativonumero(new BigDecimal(correlativonumero));
		bean.setCorrelativodesde(new BigDecimal(correlativodesde));
		bean.setCorrelativohasta(new BigDecimal(correlativohasta));
