...
public class BeanAcSucursalgrupo extends DominioTransaccion implements java.io.Serializable{
	@EmbeddedId
	private BeanAcSucursalgrupoPk pk;


	@Size(min = 0, max = 4)
	@Column(name = "SUCURSALGRUPOMAYOR", length = 4, nullable = true)
	...
	public BeanAcSucursalgrupo() {
		pk = new BeanAcSucursalgrupoPk();
	}


	public BeanAcSucursalgrupo(BeanAcSucursalgrupoPk pk) {
		this.pk = pk;
	}

	public BeanAcSucursalgrupoPk getPk() {
		return pk;
	}

	public void setPk(BeanAcSucursalgrupoPk pk) {
		this.pk = pk;
	}
