...
*/
public class BeanSySeguridadgrupoPk implements java.io.Serializable{
	...
	public BeanSySeguridadgrupoPk() {
	}

	public BeanSySeguridadgrupoPk(String paplicacioncodigo,String pgrupo) {
