...
public class DtoComunSeguridadConcepto {
	...
	private String objetoSelect;
	
	    
	
	 
	 
	public String getObjetoSelect() {
		return objetoSelect;
	}
	public void setObjetoSelect(String objetoSelect) {
		this.objetoSelect = objetoSelect;
	}
