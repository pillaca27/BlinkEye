...
*/
public class BeanWhContratodetallePk implements java.io.Serializable{
	...
	public BeanWhContratodetallePk() {
	}

	public BeanWhContratodetallePk(String pcompaniasocio,String pnumerocontrato,Integer psecuencia) {
