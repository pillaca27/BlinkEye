package net.royal.spring.as.rest;
...
//	}
	...
	public ResponseEntity<List<DtoTabla>> listarActivosPorUsuario(@RequestBody DtoTabla filtro) { 
	logger.debug("listar Activos accostcentermst.listaractivosPorTipo");
		
		List<DominioParametroPersistencia> parametros = new ArrayList<DominioParametroPersistencia>();
		 parametros.add(new DominioParametroPersistencia("par_usuario", String.class, filtro.getCodigo()));
        
        List datos = this.listarPorQuery(DtoTabla.class, "asarea.listarActivosPorUsuario", parametros);
		return new ResponseEntity<List<DtoTabla>>(datos, HttpStatus.OK); 
	}
...
//		if (UBigDecimal.esCeroOrNulo(filtro.getId()))
//			filtro.setId(null);
