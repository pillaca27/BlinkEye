...
*/
public class DtoComunCompaniamast extends DominioTransaccion implements java.io.Serializable{
	...
	*/
	...
	public BeanCompaniamast obtenerBean() {
		BeanCompaniamast bean = new BeanCompaniamast();
		return obtenerBean(bean);
	}

	public BeanCompaniamast obtenerBean(BeanCompaniamast bean) {
		if (bean == null)
			bean = new BeanCompaniamast();
