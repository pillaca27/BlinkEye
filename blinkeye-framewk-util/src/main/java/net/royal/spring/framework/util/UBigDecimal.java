...
public class UBigDecimal {
	...
	public static BigDecimal multiplicar(BigDecimal elemento1, BigDecimal elemento2) {
		return multiplicar(elemento1,elemento2,null,null);
	}
	public static BigDecimal multiplicar(BigDecimal elemento1, BigDecimal elemento2, Integer scale) {
		return multiplicar(elemento1,elemento2,scale,null);
	}
	public static BigDecimal multiplicar(BigDecimal elemento1, BigDecimal elemento2, Integer scale,RoundingMode redondeo) {
		/* valores por defecto - inicio */
		if (elemento1 == null)
			elemento1 = BigDecimal.ZERO;
		if (elemento2 == null)
			elemento2 = BigDecimal.ZERO;
		if (scale==null) {
			// https://www.ibm.com/docs/en/b2b-integrator/5.2?topic=fdif-big-decimal-bigdecimal-support-real-numbers-2
			// storage.bigDecimalMaximumDefaultScale=10
			scale=elemento1.scale()+elemento2.scale();
		}			
		if (redondeo==null) {
			// https://www.ibm.com/docs/en/b2b-integrator/5.2?topic=fdif-big-decimal-bigdecimal-support-real-numbers-2
		...
		/* valores por defecto - fin */
		
		//MathContext mc = new MathContext(scale, redondeo);	
		// DARIO este se comenta porque no funciona UBigDecimal.multiplicar(new BigDecimal("1085.56"), new BigDecimal("1.00"), 2);
		//BigDecimal xx = elemento1.multiply(elemento2, mc).setScale(scale, redondeo);
		BigDecimal xx = elemento1.multiply(elemento2).setScale(scale, redondeo); // funciona
		return xx;	
	}

	public static BigDecimal dividir(String elemento1, String elemento2) {
		MathContext precision = new MathContext(999); // example 2
		BigDecimal a = new BigDecimal(elemento1,precision);
		BigDecimal b = new BigDecimal(elemento2,precision);
		return dividir(a,b,999,null);
	}
	public static BigDecimal dividir(String elemento1, String elemento2, Integer scale) {
		MathContext precision = new MathContext(scale); // example 2
		BigDecimal a = new BigDecimal(elemento1,precision);
		BigDecimal b = new BigDecimal(elemento2,precision);
		return dividir(a,b,scale,null);
	}
	public static BigDecimal dividir(String elemento1, String elemento2, Integer scale,RoundingMode redondeo) {
		MathContext precision = new MathContext(scale); // example 2
		BigDecimal a = new BigDecimal(elemento1,precision);
		BigDecimal b = new BigDecimal(elemento2,precision);
		return dividir(a,b,scale,redondeo);
	}
	
	public static BigDecimal dividir(BigDecimal elemento1, BigDecimal elemento2) {
		return dividir(elemento1,elemento2,99,null);
	}
	public static BigDecimal dividir(BigDecimal elemento1, BigDecimal elemento2, Integer scale) {
		return dividir(elemento1,elemento2,scale,null);
	}
	public static BigDecimal dividir(BigDecimal elemento1, BigDecimal elemento2, Integer scale,RoundingMode redondeo) {
		/* valores por defecto - inicio */
		if (elemento1 == null)
			elemento1 = BigDecimal.ZERO;
		if (elemento2 == null)
		...
		//BigDecimal a = new BigDecimal(elemento1.longValue(),mc);
		//BigDecimal b = new BigDecimal(elemento2.longValue(),mc);
		//return a.divide(b); // falla
		//return a.divideToIntegralValue(b, mc).setScale(scale);	// error de calculo
				
		//elemento1.round(mc);
		//elemento2.round(mc);
		//return elemento1.divide(elemento2).setScale(scale, redondeo); // sale error
		//return elemento1.divide(elemento2,  mc).setScale(scale, redondeo);
		return elemento1.divide(elemento2,scale,redondeo);
	}
	...
	public static String convertirCadenaDefaultSinCero(BigDecimal numero) {
		String formato = "#,###,##0.00";
		
		if (numero == null || esCeroOrNulo(numero))
			return "";
	...
	public static BigDecimal multiplicarcusco(BigDecimal elemento1, BigDecimal elemento2, Integer scale) {
		if (elemento1 == null)
			elemento1 = BigDecimal.ZERO;
		if (elemento2 == null)
			elemento2 = BigDecimal.ZERO;
	...
	public static BigDecimal dividircusco(BigDecimal elemento1, BigDecimal elemento2, Integer scale) {
