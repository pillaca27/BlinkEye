...
public class SyReportearchivoServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunSyReportearchivo coreInsertar(SeguridadUsuarioActual usuarioActual,DtoComunSyReportearchivo dto) throws UException {
	...
	@Transactional
	public BeanSyReportearchivo coreInsertar(SeguridadUsuarioActual usuarioActual,BeanSyReportearchivo syReportearchivo) throws UException {
	...
	@Transactional
	public DtoComunSyReportearchivo coreActualizar(SeguridadUsuarioActual usuarioActual,DtoComunSyReportearchivo dto) throws UException {
		BeanSyReportearchivo syReportearchivo = dto.obtenerBean();
	...
	@Transactional
	public BeanSyReportearchivo coreActualizar(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivo syReportearchivo) throws UException {
		// valores por defecto - preparando objeto
	...
	@Transactional
	public DtoComunSyReportearchivo coreAnular(SeguridadUsuarioActual usuarioActual,DtoComunSyReportearchivo dto) throws UException {
		BeanSyReportearchivo syReportearchivo = dto.obtenerBean();
	...
	@Transactional
	public BeanSyReportearchivo coreAnular(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivo syReportearchivo) throws UException {
		// valores por defecto - preparando objeto
	...
	public BeanSyReportearchivo coreAnular(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivoPk pk) throws UException {
		BeanSyReportearchivo bean = syReportearchivoDao.obtenerPorId(pk);
		return coreAnular(usuarioActual,bean);
	}

	public BeanSyReportearchivo coreAnular(SeguridadUsuarioActual usuarioActual, String paplicacioncodigo,String preportecodigo,String pcompaniasocio,String pperiodo,String pversion) throws UException {
	...
	@Transactional
	public DtoComunSyReportearchivo coreEliminar(SeguridadUsuarioActual usuarioActual,DtoComunSyReportearchivo dto) throws UException {
		BeanSyReportearchivo syReportearchivo = dto.obtenerBean();
	...
	@Transactional
	public BeanSyReportearchivo coreEliminar(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivo syReportearchivo) throws UException {
		// valores por defecto - preparando objeto
	...
	public BeanSyReportearchivo coreEliminar(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivoPk pk) throws UException {
	...
	public BeanSyReportearchivo coreEliminar(SeguridadUsuarioActual usuarioActual, String paplicacioncodigo,String preportecodigo,String pcompaniasocio,String pperiodo,String pversion) throws UException {
	...
	public BeanSyReportearchivo archivosolicitudRegistrar(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivo bean)
			throws UException {
	...
	public BeanSyReportearchivo archivosolicitudActualizar(SeguridadUsuarioActual usuarioActual, BeanSyReportearchivo bean) {
		if (!UString.estaVacio(bean.getAuxString())) {
			bean.setReporte(bean.getAuxString().getBytes(StandardCharsets.UTF_8));
		}
