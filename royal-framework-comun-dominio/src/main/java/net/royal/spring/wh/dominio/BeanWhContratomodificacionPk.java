...
*/
public class BeanWhContratomodificacionPk implements java.io.Serializable{
	...
	public BeanWhContratomodificacionPk() {
	}

	public BeanWhContratomodificacionPk(String pcompaniasocio,String pnumerocontrato,Integer psecuencia) {
