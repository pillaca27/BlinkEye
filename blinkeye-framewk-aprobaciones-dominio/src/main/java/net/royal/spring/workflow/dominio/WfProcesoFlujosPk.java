...
public class WfProcesoFlujosPk implements java.io.Serializable {
	...
	public WfProcesoFlujosPk() {
	}

	public WfProcesoFlujosPk(String procesoid, Integer versionid, Integer flujoid) {
