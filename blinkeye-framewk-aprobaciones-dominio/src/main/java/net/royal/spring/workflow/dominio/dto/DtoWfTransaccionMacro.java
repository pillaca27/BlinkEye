...
*/
public class DtoWfTransaccionMacro extends DominioTransaccion implements java.io.Serializable{
	...
	public WfTransaccionMacro obtenerBean() {
		WfTransaccionMacro bean = new WfTransaccionMacro();
		return obtenerBean(bean);
	}

	public WfTransaccionMacro obtenerBean(WfTransaccionMacro bean) {
		if (bean == null)
			bean = new WfTransaccionMacro();
