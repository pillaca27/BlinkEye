 ...
 * @tabla SY_REPORTE
*/
public class WfBeanSyReportePk implements java.io.Serializable{
	...
	public WfBeanSyReportePk() {
	}

	public WfBeanSyReportePk(String paplicacioncodigo,String preportecodigo) {
