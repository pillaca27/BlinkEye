...
public class WfDtoComunSyReporte  extends DominioTransaccion implements java.io.Serializable{
	...
	public WfBeanSyReporte obtenerBean() {
		WfBeanSyReporte bean = new WfBeanSyReporte();
		return obtenerBean(bean);
	}

	public WfBeanSyReporte obtenerBean(WfBeanSyReporte bean) {
		if (bean == null)
			bean = new WfBeanSyReporte();
	...
	public void asignarBean(WfBeanSyReporte bean) {
		if (bean==null)
			return;
