...
public class WfDtoComunAplicacionesmast  extends DominioTransaccion{
	...
	public WfDtoComunAplicacionesmast() {}
	public WfDtoComunAplicacionesmast(String aplicacioncodigo) {
