...
public class WfBeanSyReporte extends DominioTransaccion implements java.io.Serializable{


	@EmbeddedId
	private WfBeanSyReportePk pk;
...
//	private java.util.Date fechareporteactualizacion;
	...
	public WfBeanSyReporte() {
		pk = new WfBeanSyReportePk();
	}


	public WfBeanSyReporte(WfBeanSyReportePk pk) {
		this.pk = pk;
	}

	public WfBeanSyReportePk getPk() {
		return pk;
	}

	public void setPk(WfBeanSyReportePk pk) {
		this.pk = pk;
	}
	/**
	 * Descripcion Local
