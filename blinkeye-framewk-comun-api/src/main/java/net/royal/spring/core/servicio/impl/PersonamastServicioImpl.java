...
public class PersonamastServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunPersonaMast coreEliminarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunPersonaMast dto) throws Exception {
		BeanPersonamast acSucursalgrupo = personamastDao.obtenerPorUuid(dto.getUuid());
	...
	@Transactional
	public DtoComunPersonaMast coreActualizarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunPersonaMast dto) throws Exception {
		BeanPersonamast acSucursalgrupo = personamastDao.obtenerPorUuid(dto.getUuid());
	...
	public DtoComunPersonaMast  coreAnularPorUuid(SeguridadUsuarioActual usuarioActual, DtoComunPersonaMast  dto)
			throws Exception {
		BeanPersonamast bean = personamastDao.obtenerPorUuid(dto.getUuid());
		...
		bean.setEstado("N");
		bean = personamastDao.coreActualizar(bean);
