...
public class TipopagoServicioValidar extends GenericoServicioValidar {
	...
	public BeanTipopago prepararInsertar(SeguridadUsuarioActual usuarioActual,BeanTipopago tipopago) {
		...
		tipopago.setUuid(UUID.randomUUID().toString());
	...
	private List<DominioMensajeUsuario> coreBasico(SeguridadUsuarioActual usuarioActual, BeanTipopago tipopago) {
		...
		if (tipopago.getPk() != null) {
			Set<ConstraintViolation<BeanTipopagoPk>> reglasPk = validator.validate(tipopago.getPk());
	...
	public List<DominioMensajeUsuario> coreEliminar(SeguridadUsuarioActual usuarioActual,BeanTipopagoPk pk) {
	...
	public List<DominioMensajeUsuario> coreAnular(SeguridadUsuarioActual usuarioActual, BeanTipopagoPk pk) {
		BeanTipopago bean = tipopagoDao.obtenerPorId(pk);
	...
	public BeanTipopago prepararAuditoria(SeguridadUsuarioActual usuarioActual, BeanTipopago asAutorizacion) {
