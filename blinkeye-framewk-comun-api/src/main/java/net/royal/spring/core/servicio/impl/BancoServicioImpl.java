...
public class BancoServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunBanco coreEliminarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunBanco dto) throws Exception {
		BeanBanco acSucursalgrupo = bancoDao.obtenerPorUuid(dto.getUuid());
	...
	@Transactional
	public DtoComunBanco coreActualizarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunBanco dto) throws Exception {
		BeanBanco acSucursalgrupo = bancoDao.obtenerPorUuid(dto.getUuid());
	...
	public DtoComunBanco  coreAnularPorUuid(SeguridadUsuarioActual usuarioActual, DtoComunBanco  dto)
			throws Exception {
		BeanBanco bean = bancoDao.obtenerPorUuid(dto.getUuid());
		...
		bean.setEstado("N");
		bean = bancoDao.coreActualizar(bean);
