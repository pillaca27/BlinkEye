...
public class MaUnidadnegocioDaoImpl extends GenericoDaoImpl<BeanMaUnidadnegocio, BeanMaUnidadnegocioPk> {
	...
	public DtoComunMaUnidadnegocio obtenerDtoPorUuid(String uuid) {
		...
		List lst = listarPorQuery(DtoComunMaUnidadnegocio.class, "maunidadnegocio.obtenerDtoPorUuid", parametros);
		if (lst.size() == 1) {
