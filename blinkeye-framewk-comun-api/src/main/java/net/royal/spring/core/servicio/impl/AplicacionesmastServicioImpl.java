...
public class AplicacionesmastServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunAplicacionesmast coreEliminarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunAplicacionesmast dto) throws Exception {
		BeanAplicacionesmast acSucursalgrupo = aplicacionesmastDao.obtenerPorUuid(dto.getUuid());
	...
	@Transactional
	public DtoComunAplicacionesmast coreActualizarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunAplicacionesmast dto) throws Exception {
		BeanAplicacionesmast acSucursalgrupo = aplicacionesmastDao.obtenerPorUuid(dto.getUuid());
	...
	public DtoComunAplicacionesmast  coreAnularPorUuid(SeguridadUsuarioActual usuarioActual, DtoComunAplicacionesmast  dto)
			throws Exception {
		BeanAplicacionesmast bean = aplicacionesmastDao.obtenerPorUuid(dto.getUuid());
		...
		bean.setEstado("N");
		bean = aplicacionesmastDao.coreActualizar(bean);
