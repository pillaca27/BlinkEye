...
public class TipopagoServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunTipopago coreEliminarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunTipopago dto) throws Exception {
		BeanTipopago acSucursalgrupo = tipopagoDao.obtenerPorUuid(dto.getUuid());
	...
	@Transactional
	public DtoComunTipopago coreActualizarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunTipopago dto) throws Exception {
		BeanTipopago acSucursalgrupo = tipopagoDao.obtenerPorUuid(dto.getUuid());
	...
	public DtoComunTipopago coreAnularPorUuid(SeguridadUsuarioActual usuarioActual, DtoComunTipopago dto)
			throws Exception {
		BeanTipopago bean = tipopagoDao.obtenerPorUuid(dto.getUuid());
		...
		bean.setEstado("N");
		bean = tipopagoDao.coreActualizar(bean);
	...
	public BeanTipopago coreAnular(SeguridadUsuarioActual usuarioActual, BeanTipopagoPk pk) throws UException {
	...
	public BeanTipopago coreAnular(SeguridadUsuarioActual usuarioActual, String ptipopago) throws UException {
		return coreAnular(usuarioActual,new BeanTipopagoPk( ptipopago));
	}
	...
	public BeanTipopago coreEliminar(SeguridadUsuarioActual usuarioActual, BeanTipopagoPk pk) throws UException {
	...
	public BeanTipopago coreEliminar(SeguridadUsuarioActual usuarioActual, String ptipopago) throws UException {
		return coreEliminar(usuarioActual,new BeanTipopagoPk( ptipopago));
	}
