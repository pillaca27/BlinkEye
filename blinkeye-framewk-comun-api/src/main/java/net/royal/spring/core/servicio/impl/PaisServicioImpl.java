...
public class PaisServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunPais coreEliminarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunPais dto) throws Exception {
		BeanPais acSucursalgrupo = paisDao.obtenerPorUuid(dto.getUuid());
	...
	@Transactional
	public DtoComunPais coreActualizarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunPais dto) throws Exception {
		BeanPais acSucursalgrupo = paisDao.obtenerPorUuid(dto.getUuid());
	...
	public DtoComunPais coreAnularPorUuid(SeguridadUsuarioActual usuarioActual, DtoComunPais dto)
			throws Exception {
		BeanPais bean = paisDao.obtenerPorUuid(dto.getUuid());
		...
		bean.setEstado("N");
		bean = paisDao.coreActualizar(bean);
