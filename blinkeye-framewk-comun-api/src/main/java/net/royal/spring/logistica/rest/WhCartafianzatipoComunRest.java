...
@RestController
@RequestMapping("/spring/logistica/whcartafianzatipocomun")
@CrossOrigin(origins = "*")
public class WhCartafianzatipoComunRest extends GenericoHibernateRest {

	private static Logger logger = LogManager.getLogger(WhCartafianzatipoComunRest.class);
	...
	public WhCartafianzatipoComunRest() {
		super("whcartafianzatipo");
	}
	...
	public ResponseEntity<List<DtoTabla>> listar() {	        	            
		logger.debug("listar");
		List datos = this.listarPorQuery(DtoTabla.class, "whcartafianzatipo.listar");
	...
	public ResponseEntity<List<DtoTabla>> listarActivos() {	        	            
		...
		List datos = this.listarPorQuery(DtoTabla.class, "whcartafianzatipo.listarActivos");
		return new ResponseEntity<List<DtoTabla>>(datos, HttpStatus.OK);
	}
	
	@ApiOperation(notes = "Obtener tabla. Entrada: DtoTabla: codigo. Retorno: DtoTabla",					
			nickname="WH_CARTA-OBT", value = "Obtener tabla.", tags = {"WH_CARTA", "OBTENER"})
	@Transactional
	@PutMapping(value = "/obtenertabla", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<DtoTabla> obtenerTabla(@RequestBody DtoTabla filtro) { 
		List<DominioParametroPersistencia> parametros = new ArrayList<DominioParametroPersistencia>();
        parametros.add(new DominioParametroPersistencia("p_tipogarantia", String.class, filtro.getCodigo()));
        List datos = this.listarPorQuery(DtoTabla.class, "whcartafianzatipo.obtenerTabla", parametros);
        DtoTabla dto = null;
        if (datos.size()==1)
	...
	public ResponseEntity<List<DtoTabla>> listarFiltros(@RequestBody DtoTabla filtro) {
		...
		List datos = this.listarPorQuery(DtoTabla.class, "whcartafianzatipo.listarfiltros",parametros);
		return new ResponseEntity<List<DtoTabla>>(datos, HttpStatus.OK);
	}
