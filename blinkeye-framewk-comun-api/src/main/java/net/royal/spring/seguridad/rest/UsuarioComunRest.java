...
import net.royal.spring.seguridad.dominio.dto.DtoComunUsuario;
import net.royal.spring.seguridad.dominio.filtro.FiltroComunUsuario;
import net.royal.spring.seguridad.dominio.lista.DtlComunUsuario;
...
public class UsuarioComunRest extends GenericoHibernateRest {
	...
	@Transactional
	@GetMapping(value = "/listarcomboTipoPlanilla", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<DtoTabla>> lista() {
		logger.debug("UsuarioComunRest.listarcomboTipoPlanilla");
		List datos = this.listarPorQuery(DtoTabla.class, "usuario.listarTipoPlanilla");
		return new ResponseEntity<List<DtoTabla>>(datos, HttpStatus.OK);
	}
	
	
	@Transactional
	@GetMapping(value = "/listarcomboSucursal", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<DtoTabla>> listarcomboSucursal() {
		logger.debug("UsuarioComunRest.listarcomboSucursal");
		List datos = this.listarPorQuery(DtoTabla.class, "usuario.listarcomboSucursal");
		return new ResponseEntity<List<DtoTabla>>(datos, HttpStatus.OK);
	}
	
	@Transactional
	@GetMapping(value = "/obtenerUnidadNegocioSeguridad", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<DtoTabla>> obtenerUnidadNegocioSeguridad() {
		logger.debug("UsuarioComunRest.obtenerUnidadNegocioSeguridad");
		SeguridadUsuarioActual user = this.getUsuarioActual();
		
		//List datos = this.listarPorQuery(DtoTabla.class, "usuario.obtenerUnidadNegocioSeguridad");
		return new ResponseEntity<List<DtoTabla>>(servicio.obtenerUnidadNegocioSeguridad(getUsuarioActual().getUsuario()), HttpStatus.OK);
	}
