...
import net.royal.spring.seguridad.servicio.impl.AplicacionesmastServicioImpl;

@RestController
@RequestMapping("/spring/seguridad/aplicacionesmast")
@CrossOrigin(origins = "*")
public class AplicacionesmastSecComunRest extends GenericoRest {

	private static Logger logger = LogManager.getLogger(AplicacionesmastSecComunRest.class);
	...
	@Transactional
	@GetMapping(value = "/obtenerporid/{aplicacioncodigo}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<BeanAplicacionesmast> obtenerPorId(@Validated @PathVariable String aplicacioncodigo)
			throws Exception {
