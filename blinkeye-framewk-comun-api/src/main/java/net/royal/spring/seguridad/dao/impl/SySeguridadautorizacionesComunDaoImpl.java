...
@Repository
public class SySeguridadautorizacionesComunDaoImpl extends GenericoDaoImpl<BeanSySeguridadautorizaciones, BeanSySeguridadautorizacionesPk> {
	...
	public SySeguridadautorizacionesComunDaoImpl() {
