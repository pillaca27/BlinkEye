...
import net.royal.spring.sistema.dominio.BeanSyUnidadreplicacionPk;
...
public class SyUnidadreplicacionServicioImpl extends GenericoServicioImpl {
	...
	@Transactional
	public DtoComunSyUnidadreplicacion coreActualizarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunSyUnidadreplicacion dto) throws Exception {
		BeanSyUnidadreplicacion acSucursalgrupo = syUnidadreplicacionDao.obtenerPorUuid(dto.getUuid());
	...
	@Transactional
	public DtoComunSyUnidadreplicacion coreEliminarPorUuid(SeguridadUsuarioActual usuarioActual,DtoComunSyUnidadreplicacion dto) throws Exception {
		BeanSyUnidadreplicacion acSucursalgrupo = syUnidadreplicacionDao.obtenerPorUuid(dto.getUuid());
