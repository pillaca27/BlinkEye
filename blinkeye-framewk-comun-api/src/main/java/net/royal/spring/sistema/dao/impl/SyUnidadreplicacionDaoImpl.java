...
import net.royal.spring.sistema.dominio.lista.DtlComunSyUnidadreplicacion;
...
public class SyUnidadreplicacionDaoImpl extends GenericoDaoImpl<BeanSyUnidadreplicacion, BeanSyUnidadreplicacionPk> {
	...
	public DtoComunSyUnidadreplicacion obtenerDtoPorUuid(String uuid) {
		...
		List lst = listarPorQuery(DtoComunSyUnidadreplicacion.class, "syunidadreplicacion.obtenerDtoPorUuid", parametros);
		if (lst.size() == 1) {
