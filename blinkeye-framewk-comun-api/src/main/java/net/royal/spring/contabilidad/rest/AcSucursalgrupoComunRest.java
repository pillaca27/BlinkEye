...
import net.royal.spring.contabilidad.dao.impl.AcSucursalgrupoDaoImpl;
import net.royal.spring.contabilidad.dominio.BeanAcSucursalgrupo;
import net.royal.spring.contabilidad.dominio.BeanAcSucursalgrupoPk;
import net.royal.spring.contabilidad.dominio.dto.DtoComunAcSucursalgrupo;
import net.royal.spring.contabilidad.dominio.filtro.FiltroComunAcSucursalgrupo;
import net.royal.spring.contabilidad.servicio.impl.AcSucursalgrupoServicioImpl;
import net.royal.spring.contabilidad.servicio.validar.AcSucursalgrupoServicioValidar;
...
@RestController
@RequestMapping("/spring/contabilidad/acsucursalgrupo")
@CrossOrigin(origins = "*")
