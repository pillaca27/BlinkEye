...
import net.royal.spring.rrhh.dominio.filtro.FiltroComunHrCursodescripcion;
...
public class HrCursodescripcionComunRest extends GenericoHibernateRest {
	...
	public ResponseEntity<DominioPaginacion> listarCursoPorFiltro(@RequestBody FiltroComunHrCursodescripcion filtro)
    {
