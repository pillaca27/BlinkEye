...
public class BeanSyReportearchivo extends DominioTransaccion implements java.io.Serializable{


	@EmbeddedId
	private BeanSyReportearchivoPk pk;
	...
	@Size(min = 0, max = 1)
	@Column(name = "VERSION_ACTUAL", length = 1, nullable = true)
	...
	public BeanSyReportearchivo() {
		pk = new BeanSyReportearchivoPk();
	}


	public BeanSyReportearchivo(BeanSyReportearchivoPk pk) {
		this.pk = pk;
	}

	public BeanSyReportearchivoPk getPk() {
		return pk;
	}

	public void setPk(BeanSyReportearchivoPk pk) {
		this.pk = pk;
	}
	/**
