...
*/
public class BeanAcCostcenterdestvalidPk implements java.io.Serializable{
	...
	@NotNull
	@NotEmpty
	@Column(name = "COSTCENTERDESTINATION", length = 6, nullable = false)
	private String costcenterdestination;


	public BeanAcCostcenterdestvalidPk() {
	}

	public BeanAcCostcenterdestvalidPk(String pcostcenter,String pcostcenterdestination) {
this.costcenter = pcostcenter;
		this.costcenterdestination = pcostcenterdestination;
	}
