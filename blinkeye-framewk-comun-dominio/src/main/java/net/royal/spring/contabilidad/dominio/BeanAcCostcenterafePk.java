...
*/
public class BeanAcCostcenterafePk implements java.io.Serializable{
	...
	@NotNull
	@NotEmpty
	@Column(name = "AFE", length = 20, nullable = false)
	private String afe;


	public BeanAcCostcenterafePk() {
	}

	public BeanAcCostcenterafePk(String pcostcenter,String pafe) {
