...
public class DtoComunPersonaMast extends DominioTransaccion implements java.io.Serializable{
	...
	/**** CAMPOS QUE VIENEN DE DtoPersonamast *******/
	...
	private BigDecimal sobregiroporcentaje;
	...
	*/
	...
	public BeanPersonamast obtenerBean() {
		return obtenerBeanCore(new BeanPersonamast(),ConstantePantallaAccion.NINGUNO);
	}

	public BeanPersonamast obtenerBeanRegistrar() {
		return obtenerBeanCore(new BeanPersonamast(),ConstantePantallaAccion.INSERTAR);
	}

	public BeanPersonamast obtenerBeanActualizar(BeanPersonamast bean) {
	...
	public BigDecimal getSobregiroporcentaje() {
		return sobregiroporcentaje;
	}

	public void setSobregiroporcentaje(BigDecimal sobregiroporcentaje) {
		this.sobregiroporcentaje = sobregiroporcentaje;
	}

	private BeanPersonamast obtenerBeanCore(BeanPersonamast bean,String tipo) {
