...
*/
public class BeanAplicacionesmastPk implements java.io.Serializable{
	...
	public BeanAplicacionesmastPk() {
	}

	public BeanAplicacionesmastPk(String paplicacioncodigo) {
