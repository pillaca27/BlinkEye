...
public class DtoComunMaMiscelaneosdetalle extends DominioTransaccion implements java.io.Serializable {
	...
	public DtoComunMaMiscelaneosdetalle(String aplicacioncodigo, String codigotabla, String compania,
	...
	public void setValornumerico(Object valornumerico) {
		if (valornumerico == null) {
			this.valornumerico = null;
		} else if (valornumerico instanceof BigDecimal) {
			this.valornumerico = (BigDecimal) valornumerico;
		} else if (valornumerico instanceof Double) {
			this.valornumerico = new BigDecimal((Double) valornumerico);
		} else {
			this.valornumerico = new BigDecimal((Integer) valornumerico);
		}
	}
