...
public class DtoComunEmpleadomast extends DominioTransaccion{
	...
	private String posicionorganigramanombre;
	private String tipocontratonombre;
	private String cargonombre;
	private String gradosalarionombre;
	private String afenombre;
	private String tipotrabajadornombre;
	private String tipohorarionombre;
	private String monedapagonombre;
	private String jeferesponsablenombre;
	private String jeferesponsablecompanianombre;
	private String usaempleado;
	...
	public String getEmpleadosexo() {
		return empleadosexo;
	}
	public void setEmpleadosexo(String empleadosexo) {
	...
	public String getPosicionorganigramanombre() {
		return posicionorganigramanombre;
	}
	public void setPosicionorganigramanombre(String posicionorganigramanombre) {
		this.posicionorganigramanombre = posicionorganigramanombre;
	}
	...
	public String getAfenombre() {
		return afenombre;
	}
	public void setAfenombre(String afenombre) {
		this.afenombre = afenombre;
	}
	...
	public String getTipohorarionombre() {
		return tipohorarionombre;
	}
	public void setTipohorarionombre(String tipohorarionombre) {
		this.tipohorarionombre = tipohorarionombre;
	}
	public String getMonedapagonombre() {
		return monedapagonombre;
	}
	public void setMonedapagonombre(String monedapagonombre) {
		this.monedapagonombre = monedapagonombre;
	}
	public String getJeferesponsablenombre() {
		return jeferesponsablenombre;
	}
	public void setJeferesponsablenombre(String jeferesponsablenombre) {
		this.jeferesponsablenombre = jeferesponsablenombre;
	}
	public String getJeferesponsablecompanianombre() {
		return jeferesponsablecompanianombre;
	}
	public void setJeferesponsablecompanianombre(String jeferesponsablecompanianombre) {
		this.jeferesponsablecompanianombre = jeferesponsablecompanianombre;
	}
	public String getUsaempleado() {
		return usaempleado;
	}
	public void setUsaempleado(String usaempleado) {
		this.usaempleado = usaempleado;
	}
