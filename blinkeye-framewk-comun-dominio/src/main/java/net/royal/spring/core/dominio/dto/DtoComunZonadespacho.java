...
*/
public class DtoComunZonadespacho extends DominioTransaccion implements java.io.Serializable{
	...
	*/
	...
	public BeanZonadespacho obtenerBean() {
		BeanZonadespacho bean = new BeanZonadespacho();
		return obtenerBean(bean);
	}

	public BeanZonadespacho obtenerBean(BeanZonadespacho bean) {
		if (bean == null)
			bean = new BeanZonadespacho();

		bean.getPk().setZonadespacho(zonadespacho);
		bean.setTransportista(transportista);
