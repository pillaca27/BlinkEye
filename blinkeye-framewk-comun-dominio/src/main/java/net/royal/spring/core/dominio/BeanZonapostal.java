...
*/
@Entity
@Table(name = "ZONAPOSTAL")
public class BeanZonapostal extends DominioTransaccion implements java.io.Serializable{


	@EmbeddedId
	private BeanZonapostalPk pk;
	...
	@Column(name = "COBRADOR", nullable = true)
	...
	@Size(min = 0, max = 10)
	@Column(name = "UBIGEO", length = 10, nullable = true)
	...
	public BeanZonapostal() {
		pk = new BeanZonapostalPk();
	}


	public BeanZonapostal(BeanZonapostalPk pk) {
		this.pk = pk;
	}

	public BeanZonapostalPk getPk() {
		return pk;
	}

	public void setPk(BeanZonapostalPk pk) {
		this.pk = pk;
	}
	/**
	 * 
