...
*/
public class BeanRtpsEmpresaexternaPk implements java.io.Serializable{
	...
	public BeanRtpsEmpresaexternaPk() {
	}

	public BeanRtpsEmpresaexternaPk(Integer pcodigoautomatico) {
