...
public class DtoComunUsuario  extends DominioTransaccion{
	...
	public List<DtoComunRtFormatogrupo> getDetalleformato() {
		return detalleformato;
	}

	public void setDetalleformato(List<DtoComunRtFormatogrupo> detalleformato) {
		this.detalleformato = detalleformato;
	}
