...
*/
public class BeanSeguridadconceptoPk implements java.io.Serializable{
	...
	@Size(min = 0, max = 6)
	@NotEmpty
	@Column(name = "CONCEPTO", length = 6, nullable = false)
	private String concepto;

	public BeanSeguridadconceptoPk() {
	}

	public BeanSeguridadconceptoPk(String paplicacioncodigo,String pgrupo,String pconcepto) {
